        ...
        <div>
            <div
                ...
                <div className="mx-auto container relative z-10 px-4 xl:px-0">
                    <div className="flow-root text-white md:pt-60 pt-32">
                        <div className="md:float-right xl:mr-64 lg:mr-8 md:mr-20 md:w-1/2 lg:w-1/2 xl:w-1/3 2xl:w-1/3 border-2 border-purpleBrand md:bg-black pt-4 md:max-w-screen-sm -mt-16 md:mb-16 ">
