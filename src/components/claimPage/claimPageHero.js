    ...
    return (
        ...
        >
            ...
            <Navbar menu={menu} setmenu={setmenu} />
              ...
              <div className="flex flex-col items-center justify-center mx-auto container px-4 xl:px-0 border-solid border-2 border-light-blue-500 w-11/12 md-7/12 lg:w-5/12 xl:w-1/3 h-434px bg-black">
