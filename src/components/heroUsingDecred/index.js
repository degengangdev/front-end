    ...
    return (
        <div>
            <div className="h-auto w-full py-10 md:py-10 lg:py-20 xl:py-20 z-10">
                <div className="flex flex-col items-center justify-center mx-auto container p-1 pb-8 text-white f-f-r">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-4 gap-8 md:place-items-end pt-8 pl-8 max-w-screen-md ">
                        ...
                        <div className="md:col-span-3">
                            ...
                            <div className="mt-2 text-sm xl:text-md">Congratulations. You’re now a true degen. Time to let the rest of the world know. 300 $DCRED to make it permanent on the blockchain and 300 $DCRED to tell them your story and write a lore. </div>
                        </div>
                        <div>
                            <img
                                alt=""
                        ...
                        <div className="md:col-span-3">
                            ...
                            <div className="mt-2">There’s rumours of evil scientists selling beasts in the degen labs. It will cost you 1000 $DCRED and you may not like what you find...Activate Beast Mode?</div>
                        </div>
                        <div>
                            <img
                                alt=""
                ...
                {/*        <div className="sm:items-center sm:justify-center md:flow-root text-white w-full mt-16">*/}
                {/*            <div className="md:float-left ">*/}
                {/*                <img*/}
                {/*                    alt=""*/}
                {/*                    className="sm:ml-8 sm:w-32 lg:h-32 lg:w-32"*/}
                {/*                    src="images/nameyourdegen.png"*/}
                {/*                />*/}
                {/*            </div>*/}
                {/*            <div className="md:float-left md:ml-16  md:w-3/5 md:h-16">*/}
                {/*                <div className="text-lg xl:text-2xl font-bold">Name your Degen on the blockchain.</div>*/}
                {/*                <div className="mt-2 text-sm xl:text-md">Congratulations. You’re now a true degen. Time to let the rest of the world know. 300 $DCRED to make it permanent on the blockchain and 300 $DCRED to tell them your story and write a lore. </div>*/}
                {/*            </div>*/}
                {/*        </div>*/}
                {/*        <div className="md:flow-root text-white w-full mt-8">*/}
                {/*            <div className="md:float-left">*/}
                {/*                <img*/}
                {/*                    alt=""*/}
                {/*                    className="sm:w-32 lg:h-32 lg:w-32"*/}
